...
def main(args):
    ...
    #Create Dummy plugin to  convert  RGBA buffer
    nvpost = Gst.ElementFactory.make("nvdspostprocess", "onscreendisplay1")
    ...
    nvpost.set_property('config-file', "config_postprocess.txt")
